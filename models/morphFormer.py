...
class Mlp(nn.Module):
    def __init__(self, dim):
        ...
        self.fc1 = Linear(dim, 1024)
        self.fc2 = Linear(1024, dim)
        self.act_fn = nn.GELU()
...
class morphFormer(nn.Module):
    def __init__(self, FM, NC, Classes, HSIOnly, patchsize):
...
if __name__ == '__main__':
    img = torch.randn(1, 80, 8, 8)
    print("input shape:", img.shape)
    net = morphFormer(16, 80, 10, False, 8)
...
# patchsize = 11
# morphformer = morphFormer(16, 144, 15, False)
# # cnn = cnn.cuda()
# summary(morphformer, (144,121), device ='cpu')