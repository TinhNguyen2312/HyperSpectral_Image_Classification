...
IEEE TGRS, 2022
spectralformer for Spectral Transformer
"""
...
def spectralformer(dataset, patch_size):
    model = None
...
class Test(nn.Module):
    def __init__(self, num_channel):
        ...
        self.skipcat = nn.Conv2d(num_channel, num_channel, [1, 2], 1, 0)
...
if __name__ == '__main__':
    t = torch.randn(size=(3, 80, 8, 8))
    print("input shape:", t.shape)
    # net = speformer(dataset='sa', patch_size=7)
    net = spectralformer(dataset='flt',patch_size=8)
